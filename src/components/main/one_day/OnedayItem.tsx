...
const OnedayItem = ({
  ...
  return (
    /* 원데이 아이템 컨테이너 */
    <div
      className="one-day-item-container"
      onClick={() => console.log('원데이 아이템 클릭!!!')}
    >
      {/* 원데이 아이템 썸네일 */}
      <div className="one-day-item-thumbnail-wrapper">
        <img
          src={imageUrl ? imageUrl : '/img/main/one_day/thumbnail2.png'}
          alt="one-day-item-thumbnail-image"
        />
      ...
      <div className="one-day-item-content-container">
        ...
        <div className="one-day-item-tag-container">
          <Tag label={category} type="challenge" color="purple" />
        </div>
        ...
        <div className="one-day-item-information-container">
          ...
          <div className="one-day-item-information-sub-container">
            ...
            <div className="one-day-item-current-members-container">
              ...
              <div className="one-day-item-member-container">
                <span className="one-day-item-member-count">
                  <span className="one-day-item-member-number">
                    {currentMembers}
                  </span>
                  /{maxMembers}
                </span>
            ...
            <div className="one-day-item-scheduled-date-container">
              ...
              <span className="one-day-item-scheduled-date">
          ...
          <div className="one-day-item-writer-container">
            <img
              src={
                profilePhoto ? profilePhoto : '/img/main/one_day/profile1.png'
              }
              alt="one-day-item-writer-profile-photo"
            />
            <span className="one-day-item-writer-nickname">
