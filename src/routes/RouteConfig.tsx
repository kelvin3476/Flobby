...
export const RouteConfig = [
  ...
  { path: '/password/reset', element: <ResetPassword />, title: '비밀번호 초기화' },
  { path: '/password/success', element: <SuccessPassword />, title: '비밀번호 변경 완료' },

  { path: '/signup/agreement', element: <Agreement />, title: '약관 동의' },
  { path: '/signup/user-info', element: <Registration />, title: '유저 정보 입력' },
  { path: '/signup/region', element: <Region />, title: '지역 선택' },
  { path: '/signup/hobby', element: <SelectHobbies />, title: '취미 선택' },
  { path: '/signup/success', element: <SuccessSignUp />, title: '회원가입 완료' },

  { path: '/oauth/kakao', element: <KakaoRedirectHandler />, title: '카카오 소셜 로그인' },
  { path: '/oauth/naver', element: <NaverRedirectHandler />, title: '네이버 소셜 로그인' },
  ...
  { path: '/club/:clubId/clubmeeting/register', element: <ClubMeetingRegister />, title: '정기 모임 등록' },
  { path: '/club/:clubId/clubmeeting/edit', element: <ClubMeetingRegister />, title: '정기 모임 수정' },
