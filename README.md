<div align="center">
    <img src="https://capsule-render.vercel.app/api?type=waving&color=764BF6&height=200&section=header&text=Flobby&fontSize=60&&animation=fadeIn&fontAlignY=38&desc=&descAlignY=51&descAlign=62" alt="Flobby">
</div>
...
| ![메인 홈페이지 화면](public/portfolio/portfolio_1.png) |                    ![챌린지 상세 페이지 화면](public/portfolio/portfolio_2.png)                    |
|:-------------------------------------:|:--------------------------------------:|
